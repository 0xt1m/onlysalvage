...
interface AddressAutocompleteProps {
  ...
  onAddressSelect: (address: { street_address: string; city: string; state: string; zip_code: string }) => void
  error?: string
  className?: string
  // For an already-filled-in field (e.g. a saved profile address) that
...
export function AddressAutocomplete({ label, placeholder, value, onChange, onAddressSelect, error, className, locked = false, onUnlock, editAriaLabel = 'Edit' }: AddressAutocompleteProps) {
  ...
  // address filling the field) doesn't immediately re-trigger a fresh
  // search for what the user just chose.
  ...
  const selectSuggestion = async (suggestion: AddressSuggestion) => {
    ...
    onChange(details.street_address)
